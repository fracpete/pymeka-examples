...
from meka.classifiers import MultiLabelClassifier, IncrementalEvaluation
...
helper.print_info("Configure BRUpdateable classifier")
br = MultiLabelClassifier(classname="meka.classifiers.multilabel.incremental.BRUpdateable")

# evaluate classifier
helper.print_info("Evaluate classifier")
result = IncrementalEvaluation.evaluate_prequential(br, data)
print(result)
